 ...
 * @Date: 2022-07-11 17:53:58
 * @LastEditors: hankaibo hankaibo@thtf.com.cn
 * @LastEditTime: 2022-07-12 20:19:48
 * @FilePath: \thtf-ui\examples\app.vue
...
export default {
  ...
  methods: {
    suggestJump() {
      ...
      const cnHref =
        href.indexOf('eleme.cn') > -1 || href.indexOf('element-cn') > -1 || href.indexOf('element.faas') > -1;
